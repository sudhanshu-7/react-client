...
const BodyAU = () => {
    return (
        ...
        <h2 className="h2 text pt-4 mt-3 pb-2">About Us</h2>
        <div className="row gy-3 mb-4 pb-2">
          <div className="col-md mt-4 ml-5">

        <p className=" h5 text pt-4 mt-3 pb-2">Welcome to Rokye!</p>
        <p className=" mb-2 mb-sm-3">Rokye is a online real-estate platform that makes it possible to rent a residential
            property without paying any brokerage and you can avail our services without any
            advance payment, We believe in service first and pay later policy.</p>
        <p className=" mb-2 mb-sm-4">Rokye Group is reimagining online real estate to make it easier to unlock life’s next
            chapter. As the most-visited real estate website in India, Rokye offer customers an
            on-demand experience for residential renting with transparency and nearly seamless
            end-to-end service.</p>
        <p className=" h5 text pt-4 mt-3 pb-2">What we do to find a next perfect home for you:</p>
        <p className=" mb-4 mb-sm-3">Firstly, we verify each listing by phone and do property inspection by personal visit
            and make sure that all the properties are posted by owners only and there are no
            middlemen or brokers. We remove all the listings done by brokers or agents
            immediately.</p>
        <p className=" mb-4 mb-sm-3">Secondly, we always make sure that all the information is available to you in easy to
            use format. So that you may get a very good idea of the property even before you
            visit them and you can shortlist them sitting at the comfort of your home without
            actually visiting all of them. By shortlisting couple of properties you can actually get a
            house in few hours and save your time, efforts and money!</p>
        <p className=" mb-4 mb-sm-5">Owners and tenants can email us at service@rokye.com and we will get in touch
            with you asap.</p>
            </div>
